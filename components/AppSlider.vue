<template>
    <section class="team-slider py-20 bg-transparent">
      <div class="container mx-auto">
        ...
        <div
          ref="carousel"
          class="carousel flex overflow-x-scroll space-x-4 scrollbar-hide snap-x snap-mandatory scroll-smooth"
        >
          <!-- 每个成员 -->
          <a
            ...
            :class="{
              'cursor-pointer': member.website,
              'cursor-default': !member.website
            }"
            target="_blank"
      ...
      return {
        teamMembers: [
          ...
          },
          {
            ...
            name: 'Hong Shuo',
            role: 'Game Designer & Engineer',
            image: '/teams/HongShuo.jpg'
          },
          {
            id: 4,
            name: 'Qin Yuqi',
            role: 'Game Designer & Engineer',
            image: '/teams/QinYuqi1.jpg',
            website: 'https://qinyuqi.portfoliobox.net/'
          },
          {
            id: 5,
            name: 'Zhao Guoqiang',
    ...
    methods: {
      startAutoScroll() {
        ...
        const slideTimer = setInterval(() => {
          ...
          const cardsPerPage = Math.floor(visibleWidth / totalCardWidth) || 1;
